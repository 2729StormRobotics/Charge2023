...
public class GridLowMid extends ParallelCommandGroup {
  ...
  public GridLowMid(Arm arm, Drivetrain drivetrain) {
    ...
    addCommands(new PointTurnGyroTank(kTurnSpeed, midHorizontalShift, m_drivetrain), new ChangeArmAngle(m_arm, lowAngle), new TelescopeToDistance(m_arm, lowExtensionDistance)); 
  }
}
