...
public class GridMidMid extends ParallelCommandGroup {
  ...
  public GridMidMid(Arm arm, Drivetrain drivetrain) {
    ...
    addCommands(new PointTurnGyroTank(kTurnSpeed, midHorizontalShift, m_drivetrain), new ChangeArmAngle(m_arm, midCubeAngle), new TelescopeToDistance(m_arm, midExtensionDistance)); 
  }
}
